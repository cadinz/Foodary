...
public class ListViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageView iconImageView = convertView.findViewById(R.id.list_image) ;
    ...
    public void addItem(Drawable icon, String name, String title) {
